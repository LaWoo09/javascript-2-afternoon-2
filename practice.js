...
  let oddArray = numbersArray.filter(num => num % 2 !== 0);
  newArray.push(evenArray, oddArray)
  return newArray
}
...
  // console.log(devMountainEmployees[i].name, cahlan.name, i, devMountainEmployees[i].name === cahlan.name)
  
...
var user2 = {
      name: 'Ohio',
      email: 'ohio@oihio.com',
      password: 'OH-HII-OHHH',
      username: 'Oh-Hi-Yo'
  };
  var user3 = {
        name: 'Mgas',
